    ...
    public partial class Seedingdatafordifficultiesandregions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4c456f5e-08a3-4ecf-abf5-1d7313156f90"), "Easy" },
                    { new Guid("6aa1455b-f764-46f7-b8f8-267b644239de"), "Hard" },
                    { new Guid("c878e504-18cb-4d3e-bfad-1ac3421eb49b"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("4c456f5e-08a3-4ecf-abf5-1d7313156f90"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("6aa1455b-f764-46f7-b8f8-267b644239de"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("c878e504-18cb-4d3e-bfad-1ac3421eb49b"));
